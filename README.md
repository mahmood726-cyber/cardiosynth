...
| `core/truthcert.html` | 1,522 | 10-validator suite (23 tests) |
| `core/provenance-store.html` | 1,494 | Audit trail + chain of custody (36 tests) |
| `core/disagreement-queue.html` | 1,501 | Two-agent arbitration UI |
| `core/metaengine.html` | 2,016 | DS-L/HKSJ engine + SVG forest plots (29 tests) |
| `core/update-engine.html` | 1,480 | Living update + synthesis versioning |
| `synthesis/bias-quantifier.html` | 1,135 | Non-posting bias, ORBI, Egger's (46 tests) |
